...
namespace Editor.Utils
{
    public static class ImGuiStyles
    {
        ...
        public static void SetupDark()
        {
            ...
            style.Colors[(int) ImGuiCol.WindowBg] = new Vector4(0.0784313753247261f, 0.08627451211214066f, 0.1019607856869698f, 1.0f); // Changed from 0.0784313753247261f, 0.08627451211214066f, 0.1019607856869698f
